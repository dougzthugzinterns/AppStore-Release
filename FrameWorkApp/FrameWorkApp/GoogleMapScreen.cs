...
namespace FrameWorkApp
{
	public partial class GoogleMapScreen : UIViewController
	{
		...
		private List<String> pathsForCurrentTrip;
		...
		public GoogleMapScreen (IntPtr handle) : base (handle)
		{
			...
			pathsForCurrentTrip = TripSummaryScreen.getPaths ();
		}
		...
		*/
		...
		public override void ViewDidAppear (bool animated)
		{
			...
			if (pathMarkers.Length > 1) {
				...
				if(pathsForCurrentTrip.Count != 0) {
					gmds.resetLastCoordinateInPath ();
					foreach(string singlePath in pathsForCurrentTrip){
